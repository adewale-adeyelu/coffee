...
const Standard = () => {
    ...
    return (  
        <section className="bg-[#FADED4] px-5 md:px-10 lg:px-16 py-10 md:py-16 flex flex-col justify-center items-center">
            <h1 className="text-[#7D2C0F] font-medium text-center text-2xl md:text-4xl" data-aos="fade-up">
                Redefining the Standard
                <br />
                of Premium Coffee
            </h1>
            <div className="pt-4 md:pt-5" data-aos="zoom-in">
                <Image src={coffee} alt="coffee" className="w-[800px]" />
            </div>
            <p className="text-center text-[#7D2C0F] pt-3 font-medium text-sm" data-aos="fade-up">
