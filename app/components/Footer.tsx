    ...
    return (  
        <footer className="bg-[#7D2C0F]" id="contact">
            <div data-aos="fade-up">
                <div className="py-10 md:py-16 px-6 md:px-10 lg:px-28 flex flex-col md:flex-row justify-between md:items-center">
                    <div className="space-y-4">
                        ...
                        <a href="#" className="flex space-x-2 items-center">
                            <Phone className="text-white font-medium" size={20} />
                            <p className="text-white font-medium text-md">
                                +234(91) 5349-7876
                            </p>
                        </a>
                        <a href="#" className="flex space-x-2 items-center">
                            <Mail className="text-white font-medium" size={20} />
                            <p className="text-white font-medium text-md">
